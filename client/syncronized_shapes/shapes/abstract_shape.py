...
class SyncronizedShape(ABC):
    def __init__(self) -> None:
        ...
        sio.emit("create_shape", (self.__uuid, self.__class__.__name__, self.to_dict()), callback=error_handler)
    ...
    def __del__(self) -> None:
        ...
        sio.emit("delete_shape", self.__uuid, callback=error_handler)
    ...
    def update_data(self):
        ...
        sio.emit("update_shape", (self.__uuid, self.__class__.__name__, self.to_dict()), callback=error_handler)
